    ...
    override(bootstrap_typeahead, "Typeahead", (input_element, options) => {
        switch (input_element.$element) {
            case $("input#stream_message_recipient_topic"): {
                ...
                expected_value =
                    '<div class="typeahead-text-container">\n' +
                    "    <strong>even more ice    </strong></div>\n";
                assert.equal(actual_value, expected_value);
            ...
            case $("textarea#compose-textarea"): {
                ...
                expected_value =
                    ...
                    '<div class="typeahead-text-container">\n' +
                    '    <strong>Othello, the Moor of Venice    </strong>    <small class="autocomplete_secondary">othello@zulip.com</small>\n' +
                    "</div>\n";
                assert.equal(actual_value, expected_value);
                ...
                expected_value =
                    ...
                    '<div class="typeahead-text-container">\n' +
                    '    <strong>hamletcharacters    </strong>    <small class="autocomplete_secondary">Characters of Hamlet</small>\n' +
                    "</div>\n";
                assert.equal(actual_value, expected_value);
